...
public class ImageSelectorPubSelectedImgsAdapter extends BaseAdapter {

	Context context;
	List<String> list;
	OnItemClickClass onItemClickClass;
	
	public ImageSelectorPubSelectedImgsAdapter(Context context, List<String> data, OnItemClickClass onItemClickClass) {
	...
	public View getView(int position, View view, ViewGroup arg2) {
		Holder holder;
		if (view==null) {
			view=LayoutInflater.from(context).inflate(R.layout.is_pub_selected_imgs_item, null);
			holder=new Holder();
