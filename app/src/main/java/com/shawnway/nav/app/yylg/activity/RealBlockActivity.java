 ...
 */
public class RealBlockActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public static void getInstance(Context context){
        Intent intent = new Intent(context, RealBlockActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CloseActivityUtil.add(RealBlockActivity.this);
    ...
    private void initToolbar() {
        ...
        centerText.setText(getResources().getString(R.string.title_activity_realblock));
