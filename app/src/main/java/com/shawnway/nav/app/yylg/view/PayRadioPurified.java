...
public class PayRadioPurified extends RelativeLayout implements Checkable {
	...
	public PayRadioPurified(Context context, AttributeSet attrs) {
		...
		inflater.inflate(R.layout.layout_item_paylist,this);
		...
		String title = array.getString(R.styleable.PayRidioButton_prbTitle);
		if (title != null) {
			setTextTitle(title);
		}
		...
		Drawable logo = array.getDrawable(R.styleable.PayRidioButton_prbLogo);
		if (logo != null) {
	...
	public void setCheckAble(boolean b) {
		payTitle.setTextColor(b?getResources().getColor(R.color.app_textColor):getResources().getColor(R.color.appcolor_gray));
		this.setClickable(b);
	}
