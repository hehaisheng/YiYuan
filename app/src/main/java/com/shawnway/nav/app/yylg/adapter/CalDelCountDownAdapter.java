 ...
 */
public class CalDelCountDownAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<CalDetCountDownFragment.CalDelResponse.CalDelBody.CalInfoItem> mData;


    public CalDelCountDownAdapter(ArrayList<CalDetCountDownFragment.CalDelResponse.CalDelBody.CalInfoItem> orders, Context context){
        mData=orders;
        mContext=context;
    }
    @Override
