...
public interface ImageSelectorIPhotoView {
    /**
     * Returns true if the PhotoViewImageSelector is set to allow zooming of Photos.
     *
     * @return true if the PhotoViewImageSelector allows zooming.
     */
    boolean canZoom();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(ImageSelectorPhotoViewAttacherImageSelector.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(ImageSelectorPhotoViewAttacherImageSelector.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(ImageSelectorPhotoViewAttacherImageSelector.OnViewTapListener listener);
