...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private float indicatorHeight = 0.75f;
    ...
    private boolean shouldExpandTabIcon;
    private boolean shouldFillTabBar = false;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        dividerColor = a
                .getColor(R.styleable.PagerSlidingTabStrip_pstsDividerColor,
                        dividerColor);
         indicatorHeight =
         a.getFloat(R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight,
                 indicatorHeight);
        ...
        tabTextColor = a.getColor(
                R.styleable.PagerSlidingTabStrip_textcolor,
                tabTextColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (indicatorStyle) {
            case STYLE_CIRCLE:
                canvas.drawCircle((lineLeft + lineRight) / 2,
                        (currentTab.getTop() + currentTab.getBottom()) / 2,
    ...
    private void drawRectangle(Canvas canvas, final int height,
                               View currentTab, float lineLeft, float lineRight) {
        canvas.drawRect(lineLeft, currentTab.getTop(), lineRight,
                currentTab.getBottom(), rectPaint);
    ...
    public void setTextSize(int textSizeDp) {
        this.tabTextSize = Utils.dp2px(getContext(),textSizeDp);
        updateTabStyles();
    }
    ...
    public void setFillTabBar(boolean b) {
        shouldFillTabBar = b;
    }
